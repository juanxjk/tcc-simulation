...
package jat.examples.jat3D.threebody;
...
{
	private static final long serialVersionUID = -9072941974713035534L;
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public threebody_vr()
	{
		...
		TG_scene.addChild(earth = new Planet3D( DE405Plus.body.EARTH_MOON_BARY,0.2f));

...
package jat.examples.jat3D.ZeroVelocitySurface;
...
{
	private static final long serialVersionUID = -7913068509451503234L;
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public ZeroVelocitySurface()
	{
		...
		TG_scene.addChild(earth = new Planet3D( DE405Plus.body.EARTH_MOON_BARY,0.5f));
		TG_scene.addChild(moon  = new Planet3D( DE405Plus.body.MOON,1));
		TG_scene.addChild(sun  = new Star3D( 0.1f));

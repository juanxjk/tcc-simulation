...
{
	private static final long serialVersionUID = -5588150152456347577L;
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public EarthOrbit()
	{
		...
		TG_scene.addChild(earth = new Planet3D( DE405Plus.body.EARTH_MOON_BARY,1.f));
		TG_scene.addChild(mainaxis = new RGBAxes3D(7000.0f));

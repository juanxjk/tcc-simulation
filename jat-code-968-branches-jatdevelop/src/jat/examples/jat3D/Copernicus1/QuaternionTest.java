...
public class QuaternionTest extends Applet implements ActionListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5611591135860247629L;
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public QuaternionTest()
	{
		...
		TG_scene.addChild(mainaxis = new RGBAxes3D(500.0f));
		...
		TG_scene.addChild(apollo = new ThreeDStudioObject( "carrier.3DS", 1.f));

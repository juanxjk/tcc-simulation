...
package jat.examples.jat3D.EarthMoon;
...
{
	private static final long serialVersionUID = -8946505233512879287L;
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public earth_moon_fly()
	{
		...
		TG_scene.addChild(apollo = new ThreeDStudioObject( "Apollo/Apollo13.3ds", 10.f));

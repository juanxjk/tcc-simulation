...
public class AddRemoveplot extends JatPlot3D {
	private static final long serialVersionUID = 599884902601254854L;

	ColorCube3D cc1= new ColorCube3D(.2);
	ColorCube3D cc2= new ColorCube3D(.3);
	
	public Node createScene() {
		Group g = new Group();
		jatScene = new jatScene3D();
		jatScene.add(cc1,"cube1");
		jatScene.add(cc2,new Vector3f(1.f,0.f,0.f),"cube2");
		g.addChild(jatScene);
